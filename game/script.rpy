...
label prologue:
    ...
    m "{size=-3}Congratulations! [pov] has reached: {b}Perversion, Level 1{/b}.{/size}"
...
label c2hottub:
    ...
    if inn >=2:
        ...
        pov "......"
        menu:
            "It was kind of exciting being seen by a girl.":
                show c3 outside 6
                with dissolve
                pov "You know..."
    ...
    menu:
        "Tease the delivery boy for a minute.":
            pov "{i}(Hmm...){/i}"
